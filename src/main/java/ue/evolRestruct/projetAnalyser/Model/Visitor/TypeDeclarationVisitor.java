...
public class TypeDeclarationVisitor extends ASTVisitor {
	private ArrayList<ClassAnalyzer> classList = new ArrayList<ClassAnalyzer>();
	...
	public ArrayList<ClassAnalyzer> getClassList() {
		return classList;
	}

	public void setClassList(ArrayList<ClassAnalyzer> classList) {
